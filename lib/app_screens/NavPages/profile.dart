...
class _ProfileState extends State<Profile> {
  ...
  //List<Color> _colorss = [Colors.white, Colors.white];
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Card(
                            ...
                            //         Alignment.center, Alignment.center, _colors)
                            //     .colors
                            //     .last
                            //     .withOpacity(0.75),
                            color: Colors.white,
                          ...
                          children: <Widget>[
                            Stack(children: <Widget>[
                              ...
                              Container(
                                ...
                                height: 70,
                                margin:
                                    EdgeInsets.fromLTRB(10.0, 70.0, 10.0, 0.0),
                                child: ListTile(
                                  leading: Icon(Icons.email),
                                  title:
                                      Text(authNotifier.userList[0].email ?? '',
                                          style: TextStyle(
                                            fontSize: 22,
                                            fontFamily: 'Montserrat',
                                          )),
                              ...
                              Container(
                                ...
                                height: 70,
                                margin:
                                    EdgeInsets.fromLTRB(10.0, 130.0, 10.0, 0.0),
                                child: ListTile(
