...
class UploadinNav extends StatefulWidget {
  const UploadinNav({Key key, @required this.isUpdating}) : super(key: key);

  final bool isUpdating;

  //Upload({@required this.isUpdating});
  @override
  _UploadinNavState createState() => _UploadinNavState();
}

class _UploadinNavState extends State<UploadinNav> {
  ...
  _showImage() {
    if (_imageFile == null || _imageUrl == null || widget.isUpdating == false) {
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
            ...
            child: Column(children: <Widget>[
              _showImage(),
              _imageFile == null || _imageUrl == null || widget.isUpdating == false
                  ? ButtonTheme(
                      child: RaisedButton(
                        onPressed: () => _getLocalImage(),
                        child: Text(
